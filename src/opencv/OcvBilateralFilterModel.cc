...
OcvBilateralFilterModel::OcvBilateralFilterModel()
{
  /* input */
...
void OcvBilateralFilterModel::process()
{
...
std::shared_ptr<NodeData> OcvBilateralFilterModel::outData(PortIndex idx)
{
  return std::make_shared<OcvData>(mat_);
}

void OcvBilateralFilterModel::Mophology(Mat& src, Mat& dst)
{
