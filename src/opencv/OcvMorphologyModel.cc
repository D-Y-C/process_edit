...
OcvMophologyModel::OcvMophologyModel()
{
  /* input */
...
void OcvMophologyModel::process()
{
...
std::shared_ptr<NodeData> OcvMophologyModel::outData(PortIndex idx)
{
  return std::make_shared<OcvData>(mat_);
}

void OcvMophologyModel::Mophology(Mat& src, Mat& dst)
{
